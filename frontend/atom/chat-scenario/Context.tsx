...
import type { ScenarioNode, BaseNode } from "@/atom/chat-scenario/type";
import { getNextNode } from "@/atom/chat-scenario"; // ← requireではなくimport
import { useArrayList, useKeyedObject } from "@/lib/useReducer/customHook";
import { tArrayListReturn, tKeyedObjectReturn } from "@/lib/useReducer/type";
